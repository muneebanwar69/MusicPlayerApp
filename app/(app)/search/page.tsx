        ...
        <div className="min-h-screen pb-32 px-6">
            ...
            {!debouncedQuery && (
                ...
                >
                    ...
                    <p className="text-xl font-semibold text-text-primary dark:text-white/80 mb-2">Start Searching</p>
                    <p className="text-text-secondary dark:text-white/50">Type to search for your favorite music</p>
                </motion.div>
            )}
        </div>
    )
