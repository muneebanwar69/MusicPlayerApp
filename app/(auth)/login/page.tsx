      ...
      >
        ...
        >
          ...
          <form onSubmit={handleEmailLogin} className="space-y-5">
            ...
            <motion.div variants={fadeIn} className="flex items-center justify-between text-sm">
              <Link
          ...
          <motion.div variants={fadeIn} className="mt-6 text-center text-sm">
            ...
            >
              ...
              <span className="group-hover:translate-x-1 transition-transform inline-block">Sign up</span>
            </Link>
          </motion.div>
        </motion.div>
      </motion.div>
